@testset "Formatters" begin
    ...
    combined = LAlatex.combine_formatters(
        [LAlatex.bold_formatter, LAlatex.color_formatter],
        1,
        1,
        1,
        "x",
    ...
    blocks = [2, -1, 2]
    colors = ["red", "blue"]
    @test LAlatex.diagonal_blocks_formatter(
        1,
        1,
        1,
        "x";
    ...
    pivots = [1, 3]
    @test LAlatex.rowechelon_formatter(1, 1, 1, "x"; pivots = pivots) ==
          "\\textcolor{red}{x}"
    @test LAlatex.rowechelon_formatter(1, 1, 2, "x"; pivots = pivots) ==
          "\\textcolor{red}{x}"
    @test LAlatex.rowechelon_formatter(1, 2, 2, "x"; pivots = pivots) == "x"
    @test LAlatex.rowechelon_formatter(1, 2, 3, "x"; pivots = pivots) ==
          "\\textcolor{red}{x}"
end
