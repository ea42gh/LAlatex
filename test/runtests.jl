...
@testset "LAlatex" begin
    ...
    @testset "HTML helpers" begin
        ...
        sanitized_html = LAlatex.to_html("x"; sz=-2, color="red; background:url(j)", justify="bogus", height=-5, width=250)
        ...
        sanitized_html2 = LAlatex.to_html("a", "b"; sz1="oops", sz2=-3, color="#abc", height="oops", width=-10)
